...
export const Step1Upload = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      {uploadError && (
        <div className="p-4 bg-[#fdf0ee] border-2 border-[#b3261e]/40 rounded-xl text-xs font-mono text-[#b3261e] flex items-center justify-between gap-3 shadow-sm animate-in fade-in duration-200">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <strong className="block text-sm font-sans font-bold">⚠ Upload Validation Error</strong>
      ...
      {backendError && !uploadError && (
        <div className="p-3 bg-[#fdf8eb] border border-[#b4690e]/40 rounded-lg text-xs font-mono text-[#b4690e] flex items-center gap-2">
          <AlertTriangle className="w-4 h-4 flex-shrink-0" />
          <span>Notice: {backendError} (Local synthetic preset validation active)</span>
        </div>
      )}
      ...
      <div className="bg-[#f8fafc] border border-[#d9e2ec] rounded-2xl p-6 text-center space-y-3">
        <div className="max-w-md mx-auto space-y-1">
          <p className="text-xs font-mono text-[#627d98]">
            {isBothFilesReady
              ? "✓ All required credentials loaded. Click below to execute full AI screening."
              : "⚠ Please upload both Identity Document (Step 1) and Traveller Selfie (Step 2) to activate screening."}
          </p>
        </div>
